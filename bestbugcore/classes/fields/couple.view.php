        ...
        <div class="bb-couples" data-name="<?php echo esc_attr($field['param_name']) ?>">     
            ...
            <?php foreach ($field['std'] as $key => $std) { ?>
                ...
                <div class="bb-couple">
                    ...
                    <select class="bb-dropdown" name="<?php echo esc_attr($field['param_name']) ?>[<?php echo bb_esc_html($count) ?>][value]">
                   ...
                   <select class="bb-dropdown" name="<?php echo esc_attr($field['param_name']) ?>[<?php echo bb_esc_html($count) ?>][value2]">
