    ...
    <main class="main col-xs-12 col-md-8" role="main">
        <section class="create-content-buzz">
          ...
          <div class="dbuzz-form-container">
                  ...
                  <ul class="list-unstyled clearfix">
                    <li class="question-item col-xs-12" ng-repeat="item in items">
                      ...
                      <div class="move-button">
                          <div ng-click="moveUpItem($index)" ng-show="$index > 0 && items.length > 1" class="move-up"><span class="ti-angle-up"></span></div>
                          <div ng-click="moveDownItem($index)" ng-show="$index < items.length - 1" class="move-down"><span class="ti-angle-down"></span></div>
                      </div>
            ...
            <br/>
            <fieldset class="scheduler-border">
              <legend class="scheduler-border"><?php esc_html_e("Footer", 'ultimate-viral-quiz') ?></legend>
              <div class="editor-footer-text">
                <div class="form-group">
                  <textarea ng-model="footerText" name="footer-text" maxlength="1000" class="form-control" id="footer-text" value="" rows="3" placeholder="<?php esc_attr_e("Enter text", 'ultimate-viral-quiz') ?>"></textarea>
                </div>
              </div>
            </fieldset>
          </div>
