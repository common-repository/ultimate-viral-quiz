<div class="bb-field-row" <?php echo bb_esc_html($dependency) ?>>
    <div class="bb-label">
        <label>
        ...
        <div class="bb-couples" data-name="<?php echo esc_attr($field['param_name']) ?>">     
            ...
            <?php foreach ($field['std'] as $key => $std) { ?>
                ...
                <div class="bb-couple">
                    ...
                    <input class="bb-field-couple" type="text" name="<?php echo esc_attr($field['param_name']) ?>[<?php echo bb_esc_html($count) ?>][value]" value="<?php echo esc_attr($std['value']) ?>" placeholder="<?php echo esc_html( $field['label'][0] ) ?>">
                    
                   <span class="label2"><b><?php echo esc_html( $field['label'][1] ) ?></b></span>
                   <select class="bb-dropdown bb-field-couple" name="<?php echo esc_attr($field['param_name']) ?>[<?php echo bb_esc_html($count) ?>][value2]">
